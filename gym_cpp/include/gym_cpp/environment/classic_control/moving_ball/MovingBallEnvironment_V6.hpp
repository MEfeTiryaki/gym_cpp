...
namespace gym{
  class MovingBallEnvironment_V6:public Environment{
    public:
      MovingBallEnvironment_V6( double maxAction=5.0, double maxPosition = 2.0,double maxSpeed = 5.0,double timeStep = 0.01):
        Environment()
      {
